...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-26 22:16:02 UTC<br>状态：成功</p>
</section>
...
<p>今日精读2篇、速读1篇，聚焦芯片热建模与存内计算性能建模。最值得关注IC-ThermBench通用化热学习基准（9.0分）及VIPER架构感知性能建模（8.0分）。建议优先复现IC-ThermBench以检验2.5D/3D-IC热仿真能力。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="IC-ThermBench: An Open, Progressive Benchmark for Generalizable 2.5D/3D-IC Thermal Learning">IC-ThermBench: An Open, Progressive Benchmark for Generalizable 2.5D/3D-IC Thermal Learning</span></li><li><span class="dpr-home-dashboard-paper-title" title="VIPER: Architecture-Aware Performance Modeling for Processing-in-Memory Design-Space Exploration">VIPER: Architecture-Aware Performance Modeling for Processing-in-Memory Design-Space Exploration</span></li></ul>
  </div>
